...
_CLIENTINFO = _descriptor.Descriptor(
    name='ClientInfo',
    full_name='distance_tracking.ClientInfo',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name='info', full_name='distance_tracking.ClientInfo.info', index=0,
...
_SERVERINFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='info', full_name='distance_tracking.ServerInfo.info', index=0,
            number=1, type=9, cpp_type=9, label=1,
            has_default_value=False, default_value=_b("").decode('utf-8'),
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
ClientInfo = _reflection.GeneratedProtocolMessageType('ClientInfo', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:distance_tracking.ClientInfo)
))
...
ServerInfo = _reflection.GeneratedProtocolMessageType('ServerInfo', (_message.Message,), dict(
    ...
    __module__='grpc_server_pb2'
    # @@protoc_insertion_point(class_scope:distance_tracking.ServerInfo)
))
...
try:
    ...
    def beta_create_DistanceServer_server(servicer, pool=None, pool_size=None, default_timeout=None,
        ...
        request_deserializers = {
            ('distance_tracking.DistanceServer', 'getDistances'): ClientInfo.FromString,
        ...
        method_implementations = {
            ('distance_tracking.DistanceServer', 'getDistances'): face_utilities.unary_stream_inline(
                servicer.getDistances),
            ('distance_tracking.DistanceServer', 'registerClient'): face_utilities.unary_unary_inline(
                servicer.registerClient),
        }
    ...
    def beta_create_DistanceServer_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
        ...
        generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
        request_serializers = {
            ('distance_tracking.DistanceServer', 'getDistances'): ClientInfo.SerializeToString,
        ...
        stub_options = beta_implementations.stub_options(host=host, metadata_transformer=metadata_transformer,
                                                         ...
                                                         thread_pool=pool, thread_pool_size=pool_size)
        return beta_implementations.dynamic_stub(channel, 'distance_tracking.DistanceServer', cardinalities,
