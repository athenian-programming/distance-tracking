...
from constants import SERIAL_PORT, BAUD_RATE, LOG_LEVEL, DEVICE_ID, GRPC_PORT_DEFAULT, GRPC_PORT, OOR_SIZE_DEFAULT, \
    OOR_SIZE, OOR_TIME_DEFAULT, OOR_TIME, OOR_UPPER_DEFAULT, OOR_UPPER
...
class DistanceTracker(object):
    def __init__(self, grpc_port=GRPC_PORT_DEFAULT,
                 oor_size=OOR_SIZE_DEFAULT,
                 oor_time=OOR_TIME_DEFAULT,
                 oor_upper=OOR_UPPER_DEFAULT):
        self.distance_server = DistanceServer(grpc_port)
...
if __name__ == "__main__":
    ...
    tracker = DistanceTracker(grpc_port=args[GRPC_PORT],
