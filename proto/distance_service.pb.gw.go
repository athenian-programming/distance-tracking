...
var (
    filter_DistanceServer_GetDistances_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_DistanceServer_GetDistances_0(ctx context.Context, marshaler runtime.Marshaler, client DistanceServerClient, req *http.Request, pathParams map[string]string) (DistanceServer_GetDistancesClient, runtime.ServerMetadata, error) {
    ...
    if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_DistanceServer_GetDistances_0); err != nil {
...
func RegisterDistanceServerHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
    ...
    mux.Handle("GET", pattern_DistanceServer_GetDistances_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
