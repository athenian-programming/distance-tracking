...
try:
  ...
  def beta_create_DistanceServer_server(servicer, pool=None, pool_size=None, default_timeout=None,
    ...
    response_serializers = {
      ...
      ('distance_server.DistanceServer', 'resetElapsed'): google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
    }
    method_implementations = {
      ('distance_server.DistanceServer', 'getDistance'): face_utilities.unary_unary_inline(servicer.getDistance),
      ('distance_server.DistanceServer', 'getDistances'): face_utilities.unary_stream_inline(servicer.getDistances),
      ('distance_server.DistanceServer', 'registerClient'): face_utilities.unary_unary_inline(servicer.registerClient),
      ('distance_server.DistanceServer', 'resetElapsed'): face_utilities.unary_unary_inline(servicer.resetElapsed),
    }
  ...
  def beta_create_DistanceServer_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('distance_server.DistanceServer', 'getDistance'): google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
